...
import com.mysummary.myproject.android_basis.recyclerview1.lemon.view.SpaceItemDecoration;
...
public class RefreshRecyclerView extends FrameLayout {
    ...
    public RefreshRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.recycler_view_);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.refresh_layout_);
